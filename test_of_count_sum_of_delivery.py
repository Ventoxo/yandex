...
class TestCountSumOfDeliveryPositive():
    ...
    По этому же принципу, убрал некоторые пограничные значения, однако считаю, что они нужны, просто их наличие очевидно,
    ...
    Если вы захотите увидеть другие тест-кейсы или узнать, как бы я реализовывал более сложные конструкции, 
                                           с удовольствием отвечу на эти вопросы на собеседовании.
